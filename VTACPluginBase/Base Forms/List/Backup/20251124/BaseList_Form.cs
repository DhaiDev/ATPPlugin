...
namespace VTACPluginBase.BaseForms.List
{
    ...
    public abstract partial class BaseList_Form : Form
    {
        ...
        // for editor form
        protected abstract string EditorFormClass { get; set; } // = "zINS_Installment";

        // for data
        protected abstract string TableName { get; set; } // = "zINS_Installment";
        protected abstract string TableQueryName { get; set; } // = "zvINS_Installment";
        protected abstract string DetailTableName { get; set; } // = "zINS_InstallmentDTL";
        protected abstract string DetailTableQueryName { get; set; } // = "zINS_InstallmentDTL";
        #endregion " Variables/Constants declaration "

        #region " Form Properties "
        #region " Required Access Rights CMD "
        protected abstract string NewDocAccessRightsCMD { get; set; }
        protected bool NewDocPermission { get => CheckPermissions(NewDocAccessRightsCMD); }
        protected abstract string EditDocAccessRightsCMD { get; set; }
        protected bool EditDocPermission { get => CheckPermissions(EditDocAccessRightsCMD); }
        protected abstract string ViewDocAccessRightsCMD { get; set; }
        protected bool ViewDocPermission { get => CheckPermissions(ViewDocAccessRightsCMD); }
        protected abstract string PrintPreviewAccessRightsCMD { get; set; }
        protected bool PrintPreviewPermission { get => CheckPermissions(PrintPreviewAccessRightsCMD); }
        protected abstract string PrintAccessRightsCMD { get; set; }
        protected bool PrintPermission { get => CheckPermissions(PrintAccessRightsCMD); }
        ...
        protected abstract string DeleteDocAccessRightsCMD { get; set; }
        protected bool DeleteDocPermission { get => CheckPermissions(DeleteDocAccessRightsCMD); }
        #endregion " Required Access Rights CMD "

        #region " Required Properties "
        protected abstract Type BusinessObjectType { get; set; }
        ...
        */
                ...
                case FormMethods.NEW:
                    {
                        ...
                        //frm_edit = new Installment_Form(enm_FormMethods);
                        ...
                        if (this.DataList_DXGrid.DataSource != null)
                        {
                            if (((DataTable)this.DataList_DXGrid.DataSource).Rows.Count > 0)
                            {
                                ...
                                if (frm_edit == null)
                                {
                                    ...
                                    frm_edit = (BaseEditor_Form)System.Reflection.Assembly.GetCallingAssembly().CreateInstance(EditorFormClass, false, System.Reflection.BindingFlags.Default, null, args, null, null);
                                    //frm_edit = new Installment_Form(enm_FormMethods, (long)dr_focused["DocKey"]);
                                    frm_edit.WindowState = FormWindowState.Normal;
                                    frm_edit.Show();
                                }
        ...
        protected virtual string GetRecGridControlList(string str_ExtraFilter = "")
        {
            string str_GetRecGridControlList = "Select * From " + TableQueryName + " ";
            string str_Where = "Where ";
            string str_OrderBy = "order by DocNo ";

            // Filter for DebtorCode
            // ===================================================================================================
                    ...
                    case "FILTER BY RANGE":
                        {
                            if ((LookUpEdtFilter02From_LUEdit.EditValue != null && LookUpEdtFilter02From_LUEdit.EditValue.ToString() != "") && (LookUpEdtFilter02To_LUEdit.EditValue != null && LookUpEdtFilter02To_LUEdit.EditValue.ToString() != ""))
                                str_Where += "U1" + SQLStrHyperLinkFilter02Key1 + " Between N'" + SQLString(LookUpEdtFilter02From_LUEdit.EditValue.ToString()) + "' and N'" + SQLString(LookUpEdtFilter02To_LUEdit.EditValue.ToString()) + "' And ";
                                ...
                                str_Where += "U1" + SQLStrHyperLinkFilter02Key1 + " Between N'" + SQLString(LookUpEdtFilter02From_LUEdit.EditValue.ToString()) + "' and N'" + SQLString(LookUpEdtFilter02From_LUEdit.EditValue.ToString()) + "' And ";
                            else if ((LookUpEdtFilter02From_LUEdit.EditValue == null || LookUpEdtFilter02From_LUEdit.EditValue.ToString() == "") && (LookUpEdtFilter02To_LUEdit.EditValue != null && LookUpEdtFilter02To_LUEdit.EditValue.ToString() != ""))
                                str_Where += "U1" + SQLStrHyperLinkFilter02Key1 + " Between N'" + SQLString(LookUpEdtFilter02To_LUEdit.EditValue.ToString()) + "' and N'" + SQLString(LookUpEdtFilter02To_LUEdit.EditValue.ToString()) + "' And ";
                            break;
                        }
                    case "FILTER BY MULTI-SELECT":
                        {
            ...
            if (str_OrderBy != "") str_GetRecGridControlList += str_OrderBy;
        ...
        private string Lstr_Filter01s = "";
        private DataTable Ldt_Filter01s = null; // added on 20110425
        protected virtual void HyperLinkFilter01_HyperLinkEdit_OpenLink(System.Object sender, DevExpress.XtraEditors.Controls.OpenLinkEventArgs e)
        {
            ...
            Filter_Frm.PrevResults = Ldt_Filter01s;
            Filter_Frm.TabPageHeaderName = "Multi-Select " + HyperLinkFilter01_HyperLinkEdit.Tag.ToString(); // added by chang on 20140521
            Filter_Frm.ShowMe(SQLStrHyperLinkFilter01, SQLStrHyperLinkFilter01Key1);
            HyperLinkFilter01_HyperLinkEdit.Text = Filter_Frm.HyperlinkText;

            if (Filter_Frm.DialogResult == DialogResult.OK)
            {
                Ldt_Filter01s = Filter_Frm.Results;
                Lstr_Filter01s = Filter_Frm.SelectedVal;
            }
        }

        private string Lstr_Filter02s = "";
        private DataTable Ldt_Filter02s = null; // added on 20110425
        protected virtual void HyperLinkFilter02_HyperLinkEdit_OpenLink(System.Object sender, DevExpress.XtraEditors.Controls.OpenLinkEventArgs e)
        {
            // Assign data visibility and clear for filter by range data
            // ================================================================
            ControlVisibility(CboFilter02_CBox.Tag.ToString(), false, true);
            LookUpEdtFilter02From_LUEdit.EditValue = null;
            LookUpEdtFilter02To_LUEdit.EditValue = null;
            // ================================================================

            FilterImport_Form Filter_Frm = new FilterImport_Form();
            Filter_Frm.PrevResults = Ldt_Filter02s;
            Filter_Frm.TabPageHeaderName = "Multi-Select " + HyperLinkFilter02_HyperLinkEdit.Tag.ToString(); // added by chang on 20140521
            Filter_Frm.ShowMe(SQLStrHyperLinkFilter02, SQLStrHyperLinkFilter02Key1);
            HyperLinkFilter02_HyperLinkEdit.Text = Filter_Frm.HyperlinkText;

            if (Filter_Frm.DialogResult == DialogResult.OK)
            {
                Ldt_Filter02s = Filter_Frm.Results;
                Lstr_Filter02s = Filter_Frm.SelectedVal;
            }
        }

        private string Lstr_Filter03s = "";
        private DataTable Ldt_Filter03s = null; // added on 20110425
        protected virtual void HyperLinkFilter03_HyperLinkEdit_OpenLink(System.Object sender, DevExpress.XtraEditors.Controls.OpenLinkEventArgs e)
        {
            // Assign data visibility and clear for filter by range data
            // ================================================================
            ControlVisibility(CboFilter03_CBox.Tag.ToString(), false, true);
            LookUpEdtFilter03From_LUEdit.EditValue = null;
            LookUpEdtFilter03To_LUEdit.EditValue = null;
            // ================================================================

            FilterImport_Form Filter_Frm = new FilterImport_Form();
            Filter_Frm.PrevResults = Ldt_Filter03s;
            Filter_Frm.TabPageHeaderName = "Multi-Select " + HyperLinkFilter03_HyperLinkEdit.Tag.ToString(); // added by chang on 20140521
            Filter_Frm.ShowMe(SQLStrHyperLinkFilter03, SQLStrHyperLinkFilter03Key1);
            HyperLinkFilter03_HyperLinkEdit.Text = Filter_Frm.HyperlinkText;

            if (Filter_Frm.DialogResult == DialogResult.OK)
            {
                Ldt_Filter03s = Filter_Frm.Results;
                Lstr_Filter03s = Filter_Frm.SelectedVal;
            }
        }
        ...
        protected abstract string ReportListingType { get; set; }
